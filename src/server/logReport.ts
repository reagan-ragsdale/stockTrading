...
export const createExcel = async (logArray: tradeLogDto[]): Promise<excelJS.Buffer> => {
    ...
    worksheet.columns = [
        ...
        { header: "EMA", key: "ema", width: 10, alignment: { horizontal: 'center' } },
        { header: "Cumulative VWAP", key: "cumulativeVWAP", width: 10, alignment: { horizontal: 'center' } },
        { header: "Rolling VWAP", key: "rollingVWAP", width: 10, alignment: { horizontal: 'center' } }/*, 
