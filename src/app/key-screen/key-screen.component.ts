...
export class KeyScreenComponent implements OnInit{
  ...
  async ngOnInit(){
    ...
    if(this.isKeysGenerated){
      ...
      window.open(`https://api.schwabapi.com/v1/oauth/authorize?response_type=code&client_id=${userKeys.appKey}&scope=readonly&redirect_uri=https://stocktrading.up.railway.app`,
        "_self"
      )
    }
  }
